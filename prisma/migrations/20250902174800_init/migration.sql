...
-- AddForeignKey
ALTER TABLE "public"."Member" ADD CONSTRAINT "Member_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES "public"."Team"("id") ON DELETE SET NULL;

-- AddForeignKey
ALTER TABLE "public"."Team" ADD CONSTRAINT "Team_ps_id_fkey" FOREIGN KEY ("ps_id") REFERENCES "public"."ProblemStatement"("id") ON DELETE RESTRICT;
